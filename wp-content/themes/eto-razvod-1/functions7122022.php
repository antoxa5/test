...
if ( ! function_exists( 'live_search' ) ) {
	function live_search( $id, $pageid = 0 ) {
		...
		//if ($pageid == 154471) {
			...
			$result .= '<meta itemprop="target" content="'.get_home_url().'/search/?q={s}"/><input itemprop="query-input" type="text" name="s" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
