...
require ($_SERVER['DOCUMENT_ROOT'].'/auth/src/autoload.php');

use Hybridauth\Hybridauth;

$config = [
    'callback' => ''.get_site_url().'/auth/callback.php',
    'providers' => [
    ...
    'Yandex' => [
        ...
        'Odnoklassniki' => [
            ...
            'keys' => [
                'id' => '512000581061',
                'key' => 'CGMONNJGDIHBABABA',
                'secret' => '41B93B02962F4123439C4356',
            ],
    ...
    jQuery(document).ready(function($){
        if (document.cookie.indexOf('loggedusertest=') != '-1') {
            ...
            if ((valercoockie == "84175") || (valercoockie == "84178")) {
                window.location.replace("/tariff/?service_id="+valercoockie);
            }
             else {
...
<script>
        function auth_popup(provider) {
            ...
            var authWindow = window.open('/auth/callback.php?provider=' + provider+'&type=front_reg', 'authWindow', 'width=600,height=400,scrollbars=yes');
...
<script type="text/javascript">
    ...
    //.click(function(){
        ...
        //window.location.replace("/balance/?service_id="+$(this).attr('data-service'));
        //window.open("/balance/?service_id="+$(this).attr('data-service'), '_blank');
    //})
