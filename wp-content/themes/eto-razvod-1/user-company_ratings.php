<?php
set_query_var('dashboard_type', 'dashboard_ratings');
set_query_var('dashboard_breadcrumb_name', 'Рейтинги');
get_header();
...
if (is_user_logged_in()) {
	echo company_dashboard_ratings($userid,$comp_id,$company_slug);
}
get_footer('profile');
?>