...
<div class="send_money">
    <div class="send_money__inside white_block block_content border_radius_4px m_t_15 flex flex_column">
        ...
        <div class="send_money__footer flex  justify-content-space-between">
            ...
            <!--<select name="send_money__footer__valute" id="send_money__footer__valute" class="border_radius_4px select_big placeholder_dark send_money__footer__valute">
...
<div class="wallet_history white_block block_content border_radius_4px m_t_15 flex flex_column">
    ...
    <!--<div class="wallet_history__row flex  align-items-center">
        <div class="wallet_history__row__title">
            <span class="wallet_history__row__span__item font_bold">Аккаунт PRO</span>
        </div>
        <div class="wallet_history__row__status">

        </div>
        <div class="wallet_history__row__amount">
            <span class="wallet_history__row__span__item font_bold"><?php /*echo number_format('400', 0, '.', ' '); */?> Р</span>
        </div>
        <div class="wallet_history__row flex align-items-center wallet_history_row_pay justify-content-center">
            <span class="wallet_history__row__icon pointer wallet_history__row__icon_balance">
            </span>
            <span class="wallet_history__row__icon pointer wallet_history__row__icon_card">
            </span>
            <span class="wallet_history__row__icon pointer wallet_history__row__icon_eb">
            </span>
        </div>
    </div>-->
	<?php
	...
	foreach ( $posts_transactions as $key => $post ) {
		...
		/*        $result .= $get_the_ID;
				$result .= get_field('services_user_add_transaction_id_transaction','user_'.$user_id)[0];*/
		...
		//$result .= '    <span class="wallet_history__row__icon pointer wallet_history__row__icon_card">';
		//$result .= '    </span>';
		//$result .= '        <span class="wallet_history__row__icon pointer wallet_history__row__icon_balance">';
		//$result .= '    </span>';
		//$result .= '        <span class="wallet_history__row__icon pointer wallet_history__row__icon_eb">';
		//$result .= '    </span>';
		$result .= '    </div>';
		$result .= '</div>';
		echo $result;
