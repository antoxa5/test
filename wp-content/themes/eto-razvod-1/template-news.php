...
if (have_posts()) :
    ...
    ?>
        <div class="page_header news_page_top news_page_top_4">
          <?php
           $news_header = '';
		...
		$news_header .= '<h1 class="color_dark_blue flex font_medium_new">'.__('Статьи','er_theme').'</h1>';
            ...
            <div class="news_header font_small">
                <div class="wrap">
                    ...
                    <ul class="news_tab_selector">
                    	...
                    	<li><a href="<?php bloginfo('url');?>/blog/"><?php _e('Блог','er_theme'); ?></a></li>
                    </ul>
	...
	<?php // echo theme_nav('fast_links_10',0,'fast_10','fast_10','link_dark_blue font_smaller'); ?>
                    ...
                    <div class="news_middle">
						...
						if($count_all_news > 30) {
							echo '<div class="button button_comments button_green pointer load_more_news font_small font_bold m_b_20" data-offset="30" data-total="'.$count_all_news.'" data-tag="all">'.__('Загрузить еще','er_theme').'</div>';
						}
