<?php
require '/var/www/eto/data/www/eto-razvod.ru/yookassa/lib/autoload.php';
...
foreach ( $arr as $item ) {
	if ($item->status == "succeeded") {
		...
		if ($id != 0) {
			if (get_field('add_options' . '_' . 'status', $id) != 'yes') {
...
Ваш баланс на сайте eto-razvod.ru был успешно пополнен '.get_the_date('j.n.Y',$id).' на сумму '.number_format($amount, 0, '.', ' ').' Р. <br>';

				if (intval($item->amount->value) == 3990) {
        ...
        <div class="send_money__footer flex  justify-content-space-between send_money__footer_step_2" style="display:none;">
            ...
            <div class="price_final">
                ...
                <div class="get_pay_method">
                    ...
                    <span value="webmoney"><input type="radio" name="paymethod" id="paymethod_3"><label for="paymethod_3">Webmoney</label></span>
