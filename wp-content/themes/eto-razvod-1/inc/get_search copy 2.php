...
if (count($prase_explode) == 1) {
	...
	if(isRussian($prase)) {
		...
		//$result .= 'RU';
		$letters = [['ай','i'],['кс','x'],['аль','al'],['с','c'],['тиньк','tink'],['блэк','black'],['э','a'],['гик','geek'],['брейн','brain'],['бреин','brain'],['гикбреин','geekbrain'],['гикбрейнс','geekbrain'],['юни','uni'],['юник','unic'],['кредит','credit']];
