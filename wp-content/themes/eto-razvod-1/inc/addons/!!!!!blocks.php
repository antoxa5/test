    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
			...
			'enqueue_assets' => function(){
			  wp_enqueue_script( 'popular_categories', get_template_directory_uri() . '/template-parts/blocks/popular_categories/popular_categories.js', array('jquery'), '', true );
			},
            'category'          => 'er-pagebuilder',
            'icon'              => 'megaphone',
        ));
...
add_action('acf/init', 'er_blocks_list_children');
function er_blocks_list_children() {
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
            'name'              => 'list_children',
            'title'             => __('Ссылки на дочерние страницы'),
            'description'       => __('Автоматическая генерация'),
            'render_template'   => 'template-parts/blocks/list_children/list_children.php',
            'enqueue_style'     => get_template_directory_uri() . '/template-parts/blocks/list_children/list_children.css',
            'category'          => 'er-pagebuilder',
        ));
    }
}
