      ...
      <?php $comment_author = get_userdata( $comment->user_id ); ?>
        ...
        <div class="comment_author_wrapper">
          ...
          <?php echo $labelpro; ?><?php echo $user_status_label; ?>
                ...
                <div class="date-line"><span class="comment_to_id color_dark_gray font_small"></span> <span class="comment-date font_small color_dark_gray date_abuse" itemprop="datePublished" content="<?php comment_date( 'Y-m-d' ); ?>" data-profile="<?php comment_date('j F Y') ?>"><?php comment_date( 'j F Y в H:i' ); ?></span></div>
			</div>
			...
			<div class="comment_fast_links hovered_<?php echo $comment->comment_ID; ?>">
                ...
                <span class="comment_more_actions_link_spam"><?php _e('Пожаловаться','er_theme'); ?></span>
           		...
           		<ul class="comment_more_actions_links comment_more_actions_links_<?php echo $comment->comment_ID; ?>">
						...
						<?php /*<li class="comment_more_actions_link_abuse"><?php _e('Пожаловаться','er_theme'); ?></li>*/ ?>
					</ul>
		   </div>
		</div>
	</div>
